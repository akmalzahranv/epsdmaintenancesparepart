        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Route::current()->getName() == 'products.wip')? 'active':''}}" href="{{ route('products.wip') }}">
                    ...
                    <p class="text">{{ __('Order') }}</p>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (Route::current()->getName() == 'products.stock.order')? 'active':''}}" href="{{ route('products.stock.order') }}">
                    <i class="nav-icon fas fa-exchange-alt"></i>
                    <p class="text">{{ __('Stock Order') }}</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Route::current()->getName() == 'products.line')? 'active':''}}" href="{{ route('products.line') }}">
                    <i class="nav-icon fas fa-list"></i>
                    <p class="text">{{ __('Line List') }}</p>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (Route::current()->getName() == 'products.machine')? 'active':''}}" href="{{ route('products.machine') }}">
                    <i class="nav-icon fas fa-th"></i>
                    <p class="text">{{ __('Machine List') }}</p>
                </a>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Route::current()->getName() == 'products.stock.history')? 'active':''}}" href="{{ route('products.stock.history') }}">
                    <i class="nav-icon fas fa-history"></i>
                    <p class="text">{{ __('Stock History') }}</p>
                </a>
            </li>
            @endif
